          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-8 md:grid-cols-2 lg:grid-cols-3 mt-10 mb-10">
            {apiData.map((singleRecord) => (
              <div
                ...
                className="flex flex-col justify-center bg-white group shadow-[0_4px_25px_rgba(56,75,255,0.15)] transform relative overflow-hidden transition delay-150 duration-200 ease-in-out"
              >
                ...
                <div className="flex gap-5 justify-between absolute bottom-0 w-full p-5 right-0">
                  <Link
